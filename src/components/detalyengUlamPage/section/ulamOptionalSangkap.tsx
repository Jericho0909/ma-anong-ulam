interface UlamSangkapProps {
    ulamOptionalSangkap: string[];
}

const UlamOptionalSangkap = ({ ulamOptionalSangkap }: UlamSangkapProps) => {
    return(
        <section className="flex items-start justify-center flex-col w-full sm:w-[80%] md:w-[75%] lg:w-[70%] xl:w-[60%] mb-4 px-3 py-1">
            ...
            >
                {ulamOptionalSangkap.map((optionalSangkap, index) => (
                    <li
                        key={index}
...
export default UlamOptionalSangkap